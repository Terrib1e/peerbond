...
## Overview
PeerBond now has three dedicated portals for different user types, each with role-based access controls and specialized functionality.
...
### Role Assignment
- Members: Regular users seeking support
- Facilitators: Experienced users who can help guide groups
...
/portal         - Auto-redirect to user's default portal
```
...
2. Routes are automatically protected based on user role
