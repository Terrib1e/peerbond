...
exports.suggestCopingStrategies = suggestCopingStrategies;
 ...
 */
async function suggestCopingStrategies(params, context) {
...
Be encouraging and specific. Avoid generic advice.`;
        ...
        if (strategiesResponse.toLowerCase().includes('breath'))
            strategyCategories.push('breathing');
        if (strategiesResponse.toLowerCase().includes('ground'))
            strategyCategories.push('grounding');
        if (strategiesResponse.toLowerCase().includes('thought'))
            strategyCategories.push('cognitive');
        if (strategiesResponse.toLowerCase().includes('body'))
            strategyCategories.push('somatic');
        if (strategiesResponse.toLowerCase().includes('social'))
            strategyCategories.push('interpersonal');
...
//# sourceMappingURL=suggestCopingStrategies.js.map